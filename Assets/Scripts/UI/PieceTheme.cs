...
namespace Chess.Game
{
    ...
    public class PieceTheme : ScriptableObject
    {
        ...
        {
            var pieceSprites = Piece.IsColour(piece, Piece.White) ? whitePieces : blackPieces;
        ...
        public class PieceSprites
        {
            ...
            {
                get { return new[] {pawn, rook, knight, bishop, queen, king}[i]; }
            }
        }
    }
}